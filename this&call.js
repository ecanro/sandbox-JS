//this y call metodo
//el metodo call invoca una funcion con un this
...
hello.call( person1, 'Hola' );//-> Hola Edgar Canro, notese que primero llamamos al objeto luego la func
...
myLanguajes.call(people1, 'JavaScript', 'PHP', 'Python');

//ahora con arreays
var languages = ['JavaScript', 'PHP', 'Python'];
myLanguajes.call(people2, languages[0], languages[1], languages[2]);
